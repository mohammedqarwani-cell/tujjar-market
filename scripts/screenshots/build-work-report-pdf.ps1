# Prints docs\presentation\tujjar-market-work-report.html to PDF with headless Microsoft Edge.
$root = Split-Path -Parent (Split-Path -Parent $PSScriptRoot)
$html = Join-Path $root "docs\presentation\tujjar-market-work-report.html"
$pdf = Join-Path $root "docs\presentation\tujjar-market-work-report.pdf"
