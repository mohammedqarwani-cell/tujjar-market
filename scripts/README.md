...
| `node scripts\security-tests\e2e-orders.mjs` | الطلبات: اشتراط تسجيل الدخول، الكمية والسعر، التوصيل مقابل الاستلام وطرق الدفع، العنوان، منع التكرار، تأكيد التاجر مع أجرة التوصيل، إلغاء الزبون، وعزل الطلبات بين المتاجر | 29 |
