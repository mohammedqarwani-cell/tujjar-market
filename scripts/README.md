...
| `node scripts\security-tests\e2e-home.mjs` | إدارة الصفحة الرئيسية: صلاحيات الفريق، البنرات (روابط داخلية فقط، صور من التخزين، الجدولة، استهداف المحافظة، الترتيب، النقرات)، ترتيب الأقسام وإخفاؤها، الستوري المثبّتة، المتاجر المميزة بالباقات، سجل التدقيق | 36 |
