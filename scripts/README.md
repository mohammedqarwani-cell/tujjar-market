...
| `node scripts\security-tests\e2e-leads.mjs` | طلبات الزبائن: التحقق من الرقم والمتجر والمنتج، منع التكرار، وصول الطلب للتاجر مع إشعار، تغيير الحالة، عزل الطلبات بين المتاجر، واحتساب الطلب تواصلاً يتيح التقييم | 16 |
