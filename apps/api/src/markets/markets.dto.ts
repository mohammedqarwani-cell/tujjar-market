...
export class UpdateMarketDto {
  @IsOptional()
  @IsString()
  @Length(2, 60, { message: MARKET_NAME })
  name?: string;
  @IsOptional()
  @IsString()
  @Length(2, 48)
...
export class GeofenceDto {
  ...
  @IsInt({ message: RADIUS })
  @Min(50, { message: RADIUS })
  @Max(3000, { message: RADIUS })
  radiusMeters!: number;
...
export class CreateCategoryDto {
  ...
  @IsString()
  @Length(1, 8, { message: 'اختر رمزاً (إيموجي) للقسم' })
  icon!: string;
  @IsOptional()
  @IsString()
  @Length(2, 48)
...
export class UpdateCategoryDto {
  @IsOptional()
  @IsString()
  @Length(2, 40, { message: CATEGORY_NAME })
  name?: string;
  @IsOptional()
  @IsString()
  @Length(1, 8, { message: 'اختر رمزاً (إيموجي) للقسم' })
...
export class InterestDto {
  @IsString() governorateId!: string;
  @IsString()
  @Length(2, 60, { message: 'الاسم بين 2 و60 حرفاً' })
  name!: string;
