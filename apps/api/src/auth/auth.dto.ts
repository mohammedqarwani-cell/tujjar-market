...
export class LoginDto {
  ...
  @IsString() @Length(1, 72) password!: string;
  @IsOptional()
  @Matches(OTP_RULE, { message: 'رمز المصادقة 6 أرقام' })
  totp?: string;
}
...
export class RegisterMerchantDto extends RegisterBaseDto {
  @IsString()
  @Length(2, 60, { message: 'اسم المتجر بين 2 و60 حرفاً' })
  storeName!: string;
  ...
  @IsBoolean()
  @Equals(true, {
    message: 'يجب التعهد بصحة معلومات المتجر ووجود المحل في السوق المختار',
  })
  attestTruth!: boolean;
}
