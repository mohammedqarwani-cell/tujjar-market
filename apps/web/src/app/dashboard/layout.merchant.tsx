...
import { BellIcon, BoxIcon, MegaphoneIcon, ChartIcon, EyeIcon, ImageIcon, LogoutIcon, PlusIcon, ShieldIcon, SlidersIcon, StarIcon, UserIcon } from "@components/ui/icons";
...
const NAV = [
  ...
  { href: "/dashboard/posts", label: "النشر", Icon: MegaphoneIcon, exact: false },
